...
alias restart_apache='docker exec easykid-pro-web rm -fr /var/cache/mason/* && docker exec easykid-pro-web apache2ctl graceful'
alias start_ekp='docker compose -f ~/git_repos/UBS\ EasyKID\ Pro/EasyKID_Pro/docker-compose-dev.yaml up -d'
